...
public class ContactListItemView extends ViewGroup
    ...
    /*Begin: Modified by siliangqi for contact_list_height 2012-4-19*/
    ...
    /*End: Modified by siliangqi for contact_list_height 2012-4-19*/
    ...
    private ImageView mSimMarkView; // add by bxinchun 2012-07-18
    ...
    private int mSimMarkViewWidth; // add by bxinchun 2012-07-19
    private int mSimMarkViewHeight; // add by bxinchun 2012-07-19
    /**
    ...
    public ContactListItemView(Context context, AttributeSet attrs) {
        ...
        /*Begin: Modified by bxinchun for displaying divider 2012/07/27*/
        //mHorizontalDividerHeight = mHorizontalDividerDrawable.getIntrinsicHeight();
        mHorizontalDividerHeight = 1;
        /*End: Modified by bxinchun for displaying divider 2012/07/27*/
    ...
    private final int indentForBladeView = 25;
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (mPhotoViewWidth > 0 || mKeepHorizontalPaddingForPhotoView) {
            /*Begin: Modified by bxinchun for sim mark view 2012/07/19*/
            /*effectiveWidth = specWidth - getPaddingLeft() - getPaddingRight()
                    - (mPhotoViewWidth + mGapBetweenImageAndText);*/

            int effWidth = specWidth - getPaddingLeft() - getPaddingRight()
                    - (mPhotoViewWidth + mGapBetweenImageAndText);
            // substract the width of sim mark view.
            if (mSimMarkViewWidth > 0) {
                effWidth = effWidth - mSimMarkViewWidth - mGapBetweenImageAndText;
            }
            // substract the width of the blade view.
            effWidth -= indentForBladeView;

            effectiveWidth = effWidth;
            /*End: Modified by bxinchun for sim mark view 2012/07/19*/
        } else {
            /*Begin: add by bxinchun 2012-08-13 set an indent for all.*/
            //effectiveWidth = specWidth - getPaddingLeft() - getPaddingRight();

            effectiveWidth = specWidth - getPaddingLeft() - getPaddingRight() - indentForBladeView;
            /*Begin: add by bxinchun 2012-08-13 set an indent for all.*/
        }
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        /*Begin: Modified by siliangqi for contacts_bg 2012-5-28*/
        //int leftBound = getPaddingLeft();
        int leftBound = 12;
        /*End: Modified by siliangqi for contacts_bg 2012-5-28*/
        int rightBound = width - getPaddingRight();

        // Put the header in the top of the contact view (Text + underline view)
        if (mHeaderVisible) {
            /*Start of siliangqi on 2012-3-6 8:44 detailed_contacts_bg*/
                /*mHeaderTextView.layout(leftBound + mHeaderTextIndent,
                        0,
                        rightBound,
                        mHeaderBackgroundHeight);*/
                mHeaderTextView.layout(leftBound + mHeaderTextIndent-24,
                        0,
                        480,
                        mHeaderBackgroundHeight);
            /*End of siliangqi on 2012-3-6 8:44 detailed_contacts_bg*/
            if (mCountView != null) {
            ...
            /*Start of siliangqi on 2012-3-6 8:44 detailed_contacts_bg*/
            mHeaderTextView.setBackgroundColor(0xdf182c42);
            /*End of siliangqi on 2012-3-6 8:44 detailed_contacts_bg*/
        ...
        if (mHorizontalDividerVisible) {
            /*Begin: Modified by bxinchun, show the divider line 2012/07/27*/
            ...
            mHorizontalDividerDrawable.setBounds(
                    ...
                    width,
                    height);
            /*End: Modified by bxinchun, show the divider line 2012/07/27*/
        ...
        rightBound -= indentForBladeView; // add 2012-08-13, add a indent of all.
        ...
        if (mPhotoPosition == PhotoPosition.LEFT) {
            ...
            /*Begin: Add by bxinchun for showing sim mark 2012/07/19*/
            if (mSimMarkView != null) {
                //rightBound -= indentForBladeView; // comment 2012-08-13

                // Center the image vertically
                final int imageTop = topBound + (bottomBound - topBound - mSimMarkViewHeight) / 2;
                mSimMarkView.layout(
                        rightBound - mSimMarkViewWidth,
                        imageTop,
                        rightBound,
                        imageTop + mSimMarkViewHeight);
                rightBound -= (mSimMarkViewWidth + mGapBetweenImageAndText);
            }
            /*End: Add by bxinchun for showing sim mark 2012/07/19*/
        } else {
            // Photo is the right most view. Right bound should be adjusted that way.
            if (photoView != null) {
                /*Begin: Add by bxinchun for leaving a indent for blade view on the overlay 2012/07/19*/
                //rightBound -= indentForBladeView; // comment 2012-08-13
                /*Begin: Add by bxinchun for leaving a indent for blade view on the overlay  2012/07/19*/
            ...
            if (mSimMarkView != null) {
                ...
                mSimMarkView.layout(
                        leftBound,
                        imageTop,
                        leftBound + mSimMarkViewWidth,
                        imageTop + mSimMarkViewHeight);
                leftBound += mSimMarkViewWidth + mGapBetweenImageAndText;
            }
            /*End: Add by bxinchun for showing sim mark 2012/07/19*/
    ...
    private void ensurePhotoViewSize() {
        if (!mPhotoViewWidthAndHeightAreReady) {
            ...
            /*Begin: Added by bxinchun for sim mark view 2012/07/19*/
            if (mPhotoViewWidth > 0 && mPhotoViewHeight > 0) {
                mSimMarkViewWidth = mSimMarkViewHeight = 48;
            } else {
                mSimMarkViewWidth = mSimMarkViewHeight = 0;
            }
            /*End: Added by bxinchun for sim mark view 2012/07/19*/
    ...
    public void setSectionHeader(String title) {
        if (!TextUtils.isEmpty(title)) {
            if (mHeaderTextView == null) {
                ...
                /*Start of siliangqi on 2012-3-6 10:41 detailed_contacts_bg*/
                //mHeaderTextView.setTextColor(mHeaderTextColor);
                mHeaderTextView.setTextColor(Color.WHITE);
                mHeaderTextView.setPadding(12,getPaddingTop(),getPaddingRight(),getPaddingBottom());
                /*End of siliangqi on 2012-3-6 10:41 detailed_contacts_bg*/
            ...
            if (mHeaderDivider == null) {
                ...
                /*Start of siliangqi on 2012-3-6 10:40 detailed_contacts_bg*/
                mHeaderDivider.setBackgroundColor(mHeaderUnderlineColor);
                /*End of siliangqi on 2012-3-6 10:40 detailed_contacts_bg*/
    ...
    /**
     * Returns the sim mark view, creating it if necessary.
     * @author bxinchun 2012-07-19
     */
    public ImageView getSimMarkView() {
        if (mSimMarkView == null) {
            mSimMarkView = new ImageView(mContext);

            addView(mSimMarkView);
        }
    ...
    public void removePhotoView(boolean keepHorizontalPadding, boolean keepVerticalPadding) {
        ...
        /*Begin: Modified by bxinchun, remove sim mark view when photo view is not exists 2012/07/26*/
        if (mSimMarkView != null) {
            removeView(mSimMarkView);
            mSimMarkView = null;
        }
        /*End: Modified by bxinchun, remove sim mark view when photo view is not exists 2012/07/26*/
    }
    ...
    public TextView getNameTextView() {
        if (mNameTextView == null) {
            ...
            /*Start of siliangqi on 2012-3-7 9:32 contact_bg*/
            mNameTextView.setTextColor(Color.WHITE);
            /*End of siliangqi on 2012-3-7 9:32 contact_bg*/
    ...
    public TextView getCountView() {
        if (mCountView == null) {
            ...
            /*Start of siliangqi on 2012-3-6 10:41 detailed_contacts_bg*/
            mCountView.setTextSize(TypedValue.COMPLEX_UNIT_SP, mCountViewTextSize);
            /*End of siliangqi on 2012-3-6 10:41 detailed_contacts_bg*/
            addView(mCountView);
        }
        return mCountView;
    ...
    public void showDisplayName(Cursor cursor, int nameColumnIndex, int displayOrder) {
        ...
        if (!TextUtils.isEmpty(name)) {
            ...
            if(mHighlightedPrefix!=null){
                name = mPrefixHighligher.apply(name, cursor, mHighlightedPrefix);
            }else
