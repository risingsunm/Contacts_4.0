...
//        }
    ...
    protected View newHeaderView(Context context, int partition, Cursor cursor,
        ...
        /*Begin: Modified by bxinchun, made the header unable to touch or click 2012/07/31*/
        //return inflater.inflate(R.layout.directory_header, parent, false);
        View header = inflater.inflate(R.layout.directory_header, parent, false);
        header.setClickable(false);
        header.setEnabled(false);
        return header;
        /*End: Modified by bxinchun, made the header unable to touch or click 2012/07/31*/
    }
    ...
    protected void bindQuickContact(final ContactListItemView view, int partitionIndex,
        ...
        long contactId = 0;
        if (!cursor.isNull(contactIdColumn)) {
            contactId = cursor.getLong(contactIdColumn);
        }
        getPhotoLoader().loadPhoto(quickContact, photoId, false, mDarkTheme, contactId);
