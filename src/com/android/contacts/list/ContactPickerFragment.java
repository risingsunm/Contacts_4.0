...
public class ContactPickerFragment extends ContactEntryListFragment<ContactEntryListAdapter>
    ...
    private boolean withoutSimContacts = false;

    public void setWithoutSimContacts(boolean withoutSimContacts) {
        this.withoutSimContacts = withoutSimContacts;
    }
