...
public class PhoneFavoriteMergedAdapter extends BaseAdapter implements SectionIndexer {
    ...
    public Object getItem(int position) {
        ...
        if (position < contactTileAdapterCount) {
            ...
            /*Begin: Modified by bxinchun 2012-08-02 for add touch view func.*/
            //return mContactTileAdapter.getItem(localPosition);

            return mContactEntryListAdapter.getItem(localPosition);
            /*End: Modified by bxinchun 2012-08-02 for add touch view func.*/
        }
    }
    ...
    /*Begin: Added by bxinchun, return the position in the phone number list. 2012-07-31*/
    public boolean isTouchViewItem(int position) {
        try {
            final int contactTileAdapterCount = mContactTileAdapter.getCount();
            //final int contactEntryListAdapterCount = mContactEntryListAdapter.getCount();
    ...
    /*End: Added by bxinchun, return the position in the phone number list. 2012-07-31*/
    @Override
