    ...
    public void bindView(boolean dropdown) {
        ...
        switch (mFilter.filterType) {
            case ContactListFilter.FILTER_TYPE_ALL_ACCOUNTS: {
                /*Begin: Modified by siliangqi for display_contact 2011-6-6*/
                /*bindView(R.drawable.ic_menu_contacts_holo_light, R.string.list_filter_all_accounts,
                        dropdown);*/
                bindView(R.drawable.ic_launcher_contacts, R.string.list_filter_all_accounts,
                        dropdown);
                /*End: Modified by siliangqi for display_contact 2011-6-6*/
                break;
            }
            ...
            case ContactListFilter.FILTER_TYPE_CUSTOM: {
                /*Begin: Modified by siliangqi for display_contact 2012-6-8*/
                /*bindView(R.drawable.ic_menu_settings_holo_light,
                        dropdown ? R.string.list_filter_customize : R.string.list_filter_custom,
                        dropdown);*/
                    bindView(R.drawable.ic_menu_settings_holo_light1,
                        dropdown ? R.string.list_filter_customize : R.string.list_filter_custom,
                        dropdown);
                /*End: Modified by siliangqi for display_contact 2012-6-8*/
                break;
            }
            ...
            case ContactListFilter.FILTER_TYPE_ACCOUNT: {
                ...
                /*Begin: Modified by siliangqi for display_contact 2011-6-9*/
                if(mFilter.accountName.equals("PHONE"))
                    mIcon.setImageResource(R.drawable.ic_menu_phone_holo_light);
                else if(mFilter.accountName.equals("SIM1")||mFilter.accountName.equals("SIM2"))
                    mIcon.setImageResource(R.drawable.ic_menu_sim_holo_light);
                /*End: Modified by siliangqi for display_contact 2011-6-9*/
