...
public class ContactTileAdapter extends BaseAdapter {
    ...
    /*Begin: Added by bxinchun 2012-08-01, add the touch view func.*/
    /**
     * return true if the item position support touch view func.
     */
    public boolean isTouchViewItem(int position) {
        ...
        int columnCount = getColumnCount(itemViewType);
        if (columnCount == 1) {
            return true;
        }
        return false;
    ...
    /**
     * return the column count of the item view type.
     */
    private int getColumnCount(int itemViewType) {
        return itemViewType == ViewTypes.FREQUENT ? 1 : mColumnCount;
    }
    /*End: Added by bxinchun 2012-08-01, add the touch view func.*/
