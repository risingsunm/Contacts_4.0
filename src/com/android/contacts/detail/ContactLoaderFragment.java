...
public class ContactLoaderFragment extends Fragment implements FragmentKeyListener {
    ...
    public void onPrepareOptionsMenu(Menu menu) {
        ...
        if (optionsSendToVoicemail != null) {
            /*Begin: Modified code by bxinchun to set the item invisible 2012/07/14*/
            ...
            /*End: Modified code by bxinchun to set the item invisible 2012/07/14*/
        }
...
/*Begin: Modified by xiepengfei for delete superabundance menu 2012/05/23*/
//        final MenuItem editMenu = menu.findItem(R.id.menu_edit);
//        editMenu.setVisible(mOptionsMenuEditable);
        final MenuItem editMenu = menu.findItem(R.id.menu_edit);
        editMenu.setVisible(false);
/*End: Modified by xiepengfei for delete superabundance menu 2012/05/23*/


        /*Begin: Modified by xiepengfei for  2012/03/29*/
        final MenuItem editMenu2 = menu.findItem(R.id.menu_edit2);
        editMenu2.setVisible(mOptionsMenuEditable);
        /*End: Modified by xiepengfei for  2012/03/29*/

        final MenuItem deleteMenu = menu.findItem(R.id.menu_delete);
        deleteMenu.setVisible(mOptionsMenuEditable);


        /*Begin: Modified by xiepengfei for delete share menu 2012/03/30*/
//        final MenuItem shareMenu = menu.findItem(R.id.menu_share);
//        shareMenu.setVisible(mOptionsMenuShareable);
        /*End: Modified by xiepengfei for delete share menu 2012/03/30*/
    ...
    private void sendContactViaSMS() {
        ...
        for (Entity entity: mContactData.getEntities()) {
            ...
            for (NamedContentValues subValue : entity.getSubValues()) {
                ...
                } else if (StructuredPostal.CONTENT_ITEM_TYPE.equals(mimeType)) { // Get StructuredPostal address string
                    if (postal == null) {
                        postal = entryValues.getAsString(StructuredPostal.FORMATTED_ADDRESS);
                    } else {
                        postal = postal + ", " + entryValues.getAsString(StructuredPostal.FORMATTED_ADDRESS);
                    }
                } else if (Organization.CONTENT_ITEM_TYPE.equals(mimeType)) { // Get Organization string
                    if (organization == null) {
                        organization = entryValues.getAsString(Organization.COMPANY);
                    } else {
                        organization = organization + ", " + entryValues.getAsString(Organization.COMPANY);
                    }
                }
            }
