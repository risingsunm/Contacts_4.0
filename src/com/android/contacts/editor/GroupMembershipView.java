...
public class GroupMembershipView extends LinearLayout
    ...
    private void updateView() {
        ...
        /*Begin: Modified by xiepengfei for modify the button text color 2012/06/02*/
//        if (sb.length() == 0) {
...
//        }
        if (sb.length() == 0) {
            mGroupList.setText(mNoGroupString);
            mGroupList.setTextColor(Color.BLACK);
        } else {
            mGroupList.setText(sb);
            mGroupList.setTextColor(Color.BLACK);
        }
        /*End: Modified by xiepengfei for modify the button text color 2012/06/02*/
