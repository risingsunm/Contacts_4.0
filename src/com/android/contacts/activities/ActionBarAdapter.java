...
/*Start of wangqiang on 2012-3-6 11:30 contact_and_dialer_actionbar*/
import android.app.ActionBar.TabListener;
import android.app.Activity;
import android.app.Fragment;
import android.content.Intent;
/*End of wangqiang on 2012-3-6 11:30 contact_and_dialer_actionbar*/
...
public class ActionBarAdapter implements OnQueryTextListener, OnCloseListener {
    ...
    private int[] tab_image_press = {R.drawable.phonebook_tab_icon_group_press,R.drawable.phonebook_tab_icon_contacts_press,R.drawable.phonebook_tab_icon_favorite_press};
    private int[] tab_image_normal = {R.drawable.phonebook_tab_icon_group,R.drawable.phonebook_tab_icon_contacts,R.drawable.phonebook_tab_icon_favorite};
    ...
    public ActionBarAdapter(Context context, Listener listener, ActionBar actionBar,
        ...
        /*Start of wangqinag on 2012-3-9 15:0 contact_and_dialer_actionbar*/
        // Set up tabs
        /*
        ...
        */
        ...
        addTabFavorite();
        addTabToPhone();
        /*End of wangqinag on 2012-3-9 15:0 contact_and_dialer_actionbar*/
    }
    ...
    */
    ...
    /*Start of wangqinag on 2012-3-9 15:2 contact_and_dialer_actionbar*/
    /*
    ...
    */
    ...
    private void addTabGroup() {
        ...
        final Tab tab = mActionBar.newTab();
        tab.setTag(TabState.GROUPS);
        tab.setContentDescription(R.string.contactsGroupsLabel);
        tab.setCustomView(R.layout.util_grouplabel);
        tab.setTabListener(mTabListener);
        mActionBar.addTab(tab);
    }
    private void addTabFavorite() {

        final Tab tab = mActionBar.newTab();
        tab.setTag(TabState.FAVORITES);
        tab.setContentDescription(R.string.contactsFavoritesLabel);
        tab.setCustomView(R.layout.util_favoritelabel);
        tab.setTabListener(mTabListener);
        mActionBar.addTab(tab);
    }
    private void addTabAll() {
        ...
        final Tab tab = mActionBar.newTab();
        tab.setTag(TabState.ALL);
        tab.setContentDescription(R.string.contactsAllLabel);
        tab.setCustomView(R.layout.util_alllabel);
        tab.setTabListener(mTabListener);
        mActionBar.addTab(tab);
    }

    private void addTabToPhone() {
        final Tab tab = mActionBar.newTab();
        tab.setCustomView(R.layout.util_phone);
        ...
        tab.setTabListener(new TabListener() {
            ...
            public void onTabSelected(Tab tab, FragmentTransaction ft) {
                // TODO Auto-generated method stub
                final Intent intent= new Intent(mContext,DialtactsActivity.class);
    ...
    /*End of wangqinag on 2012-3-9 15:2 contact_and_dialer_actionbar*/
    ...
    private class MyTabListener implements ActionBar.TabListener {
        ...
        @Override public void onTabUnselected(Tab tab, FragmentTransaction ft) { 
             /*Begin: Modified by siliangqi for actionbar_font 2012-6-8*/
            ((ImageView)(((LinearLayout)mActionBar.getTabAt(tab.getPosition()).getCustomView()).getChildAt(0))).setImageResource(tab_image_normal[tab.getPosition()]);
            ((TextView)(((LinearLayout)mActionBar.getTabAt(tab.getPosition()).getCustomView()).getChildAt(1))).setTextColor(Color.rgb(160, 160, 160));
            /*End: Modified by siliangqi for actionbar_font 2012-6-8*/
        }

        @Override public void onTabSelected(Tab tab, FragmentTransaction ft) {
             /*Begin: Modified by siliangqi for actionbar_font 2012-6-8*/
            ((ImageView)(((LinearLayout)mActionBar.getTabAt(tab.getPosition()).getCustomView()).getChildAt(0))).setImageResource(tab_image_press[tab.getPosition()]);
            ((TextView)(((LinearLayout)mActionBar.getTabAt(tab.getPosition()).getCustomView()).getChildAt(1))).setTextColor(Color.rgb(235, 235, 235));
            /*End: Modified by siliangqi for actionbar_font 2012-6-8*/
    ...
    public void setCurrentTab(TabState tab, boolean notifyListener) {
        ...
        /*Start of wangqinag on 2012-3-9 15:3 contact_and_dialer_actionbar*/
        if (notifyListener && mListener != null) mListener.onSelectedTabChanged();
        /*
        if (notifyListener && mListener != null) mListener.onSelectedTabChanged();
        saveLastTabPreference(mCurrentTab);
        */
        /*End of wangqinag on 2012-3-9 15:3 contact_and_dialer_actionbar*/
    }
    ...
    public boolean isSearchMode() {
        /*Begin: Modified by siliangqi for 1lev_search 2012-4-11*/
        //return mSearchMode;
        return false;
        /*End: Modified by siliangqi for 1lev_search 2012-4-11*/
    }
