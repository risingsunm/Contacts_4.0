...
/*Begin: Modified by siliangqi for location_search 2012-4-27*/
import java.util.HashMap;
import com.android.contacts.LocSearchUtil;
import android.database.Cursor;
/*End: Modified by siliangqi for location_search 2012-4-27*/
...
public class DialtactsActivity extends TransactionSafeActivity {
    ...
    /*Begin: Modified by siliangqi for multi_delete 2012-3-30*/
    private CallLogFragment myCallLogFragment;
    /*End: Modified by siliangqi for multi_delete 2012-3-30*/
   ...
   private static final String MSIM_CALL_SETTINGS_CLASS_NAME =
    ...
    /*Begin: Modified by siliangqi for actionbar_font 2012-6-8*/
    private int[] tab_image_press = {R.drawable.phonebook_tab_icon_keypad_press,R.drawable.phonebook_tab_icon_history_press,R.drawable.phonebook_tab_icon_favorite_press};
    private int[] tab_image_normal = {R.drawable.phonebook_tab_icon_keypad,R.drawable.phonebook_tab_icon_history,R.drawable.phonebook_tab_icon_favorite};
    /*End: Modified by siliangqi for actionbar_font 2012-6-8*/
    /**
    ...
    public class ViewPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            switch (position) {
                ...
                /* Begin: Modified by siliangqi for multi_delete 2012-3-30 */
                final CallLogFragment myCallLogFragment = new CallLogFragment();
                DialtactsActivity.this.myCallLogFragment = myCallLogFragment;
                mCallLogFragment
                        .setOnMenuDeleteClickListener(new CallLogFragment.OnMenuDeleteClickListener() {
                            public void onClick(boolean flag) {
                                getActionBar().hide();
                                if (flag) {
                                    mViewPager.setVisibility(View.GONE);
                                    myCallLogFragment.setEnterDeleteUi(true);
                                    FragmentTransaction ft = getFragmentManager()
                                            .beginTransaction();
                                    if (!myCallLogFragment.isAdded()) {
                                        ft.add(R.id.dialtacts_frame,
                                                myCallLogFragment);
                                    } else {
                                        ft.show(myCallLogFragment);
                                        myCallLogFragment.initDeleteUi();
                                        myCallLogFragment.getAllCallTypeBut()
                                                .setChecked(true);
                                        View v = new View(
                                                DialtactsActivity.this);
                                        v.setId(0);
                                        myCallLogFragment.getCallTypeListener()
                                                .onClick(v);
                                        myCallLogFragment
                                                .getSlotListener()
                                                .onClick(
                                    ...
                                    getActionBar().setBackgroundDrawable(getApplication().getResources().getDrawable(R.drawable.ic_actionbar_bg));
                                    getActionBar()
                                            .setDisplayOptions(
                                    ...
                                    getActionBar()
                                            .setTitle(
                                                    getString(R.string.recentCalls_delete));*/
                                } else {
                                getActionBar().show();
                                    mViewPager.setVisibility(View.VISIBLE);
                                    FragmentTransaction ft = getFragmentManager()
                                            .beginTransaction();
                                    ft.hide(myCallLogFragment);
                                    ft.commit();
                                    mCallLogFragment.setDeleteRecover();
                                    // mCallLogFragment.delete_flag = false;
                                    // getActionBar().setNavigationMode(ActionBar.NAVIGATION_MODE_TABS);
                                    //getActionBar().setDisplayOptions(getActionBar().getDisplayOptions()^(ActionBar.DISPLAY_SHOW_HOME));
                                }
                            }
                        });
                /* End: Modified by siliangqi for multi_delete 2012-3-30 */
    ...
    private final TabListener mTabListener = new TabListener() {
        ...
        /*Begin: Modified by siliangqi for actionbar_font 2012-6-8*/
        ((ImageView)(((LinearLayout)getActionBar().getTabAt(tab.getPosition()).getCustomView()).getChildAt(0))).setImageResource(tab_image_normal[tab.getPosition()]);
        ((TextView)(((LinearLayout)getActionBar().getTabAt(tab.getPosition()).getCustomView()).getChildAt(1))).setTextColor(Color.rgb(160, 160, 160));
        /*End: Modified by siliangqi for actionbar_font 2012-6-8*/
        ...
        public void onTabSelected(Tab tab, FragmentTransaction ft) {
            ...
            /*Begin: Modified by siliangqi for actionbar_font 2012-6-8*/
            ((ImageView)(((LinearLayout)getActionBar().getTabAt(tab.getPosition()).getCustomView()).getChildAt(0))).setImageResource(tab_image_press[tab.getPosition()]);
            ((TextView)(((LinearLayout)getActionBar().getTabAt(tab.getPosition()).getCustomView()).getChildAt(1))).setTextColor(Color.rgb(235, 235, 235));
            /*End: Modified by siliangqi for actionbar_font 2012-6-8*/
    ...
    protected void onCreate(Bundle icicle) {
        ...
        new Thread() {
            ...
            public void run() {
                ...
                if (LocSearchUtil.locSearch == null) {
                    ...
                    Uri mUri = Uri.parse("content://com.khong.provider.phonemanager/location/");
                    Cursor cursor = getContentResolver().query(mUri, null, null, null, null);
                    if (cursor==null||0 == cursor.getCount())
                        return;
                    cursor.moveToFirst();
                    do {
                        if (LocSearchUtil.locSearch.containsKey(cursor.getString(1)))
                            continue;
                        LocSearchUtil.locSearch.put(cursor.getString(1), cursor.getString(2));
        ...
        setupDialer();
        setupCallLog();
        /*Start of wangqiang on 2012-3-9 15:9 contact_and_dialer_actionbar*/
        /*setupFavorites();*/
        setupContacts();
        setupToContact();
        /*End of wangqiang on 2012-3-9 15:9 contact_and_dialer_actionbar*/
        getActionBar().setNavigationMode(ActionBar.NAVIGATION_MODE_TABS);
        ...
        /*Start of wangqiang on 2012-3-9 15:10 contact_and_dialer_actionbar*/
        /*
        ...
        */
        ...
        mLastManuallySelectedFragment = PREF_LAST_MANUALLY_SELECTED_TAB_DEFAULT;
        /*End of wangqiang on 2012-3-9 15:10 contact_and_dialer_actionbar*/
    ...
    /*Start of wangqiang on 2012-3-9 15:11 contact_and_dialer_actionbar*/

    public void setupToContact(){
        final ActionBar ab = getActionBar();
        final Tab tab =ab.newTab();
        tab.setContentDescription(R.string.contactsAllLabel);
        tab.setTabListener(new TabListener() {
            ...
            public void onTabSelected(Tab tab, FragmentTransaction ft) {
                ...
                intent.setClass(DialtactsActivity.this, PeopleActivity.class);
        ...
        tab.setCustomView(R.layout.util_contacts);
    ...
    private void setupDialer() {
        ...
        tab.setCustomView(R.layout.util_keypadlabel);
        getActionBar().addTab(tab);
    }
    ...
    private void setupCallLog() {
        ...
        tab.setCustomView(R.layout.util_historylabel);
        tab.setTabListener(mTabListener);
        getActionBar().addTab(tab);
    }
    ...
    private void setupContacts() {
        final Tab tab = getActionBar().newTab();
        tab.setContentDescription(R.string.contactsList);
        tab.setCustomView(R.layout.util_contactslabel);
        tab.setTabListener(mTabListener);
        getActionBar().addTab(tab);
    }
    ...
    */
    /*End of wangqiang on 2012-3-9 15:11 contact_and_dialer_actionbar*/
    ...
    public void onBackPressed() {
        if (mInSearchUi) {
        ...
        } else if (mCallLogFragment.delete_flag) {
            mCallLogFragment.setDeleteRecover();
            getActionBar().show();
            //getActionBar().setDisplayOptions(getActionBar().getDisplayOptions()^(ActionBar.DISPLAY_SHOW_HOME));
            mViewPager.setVisibility(View.VISIBLE);
            ...
            if(mDialpadFragment!=null)
                mDialpadFragment.getDigitsWidget().setText("");
    ...
    public void startSearch(String initialQuery, boolean selectInitialQuery,
        ...
        /*Begin: Modified by siliangqi for 1lev_search 2012-4-14*/
        ...
        /*End: Modified by siliangqi for 1lev_search 2012-4-14*/
    }
