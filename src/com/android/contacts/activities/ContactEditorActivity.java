...
/*Begin: Modified by xiepengfei for add menu 2012/05/23*/
import android.view.MenuItem;
import android.widget.Button;
import android.view.View.OnClickListener;
/*End: Modified by xiepengfei for add menu 2012/05/23*/
...
public class ContactEditorActivity extends ContactsActivity
    ...
    public void onCreate(Bundle savedState) {
        ...
        /*Begin: Modified by xiepengfei for modify editor activity 2012/04/25*/
//        if (actionBar != null) {
...
//        }
        if (actionBar != null) {
            // Show the custom action bar and show the home icon and title
            ...
            if(action.equals(Intent.ACTION_EDIT)){
                ...
                actionBar.setTitle(R.string.insertContactDescription);
            }
            /*Begin: Modified by bxinchun for changing the icon 2012/07/26*/
            actionBar.setIcon(R.drawable.ic_contact_picture); //R.drawable.ic_launcher_shortcut_contact
            /*End: Modified by bxinchun for changing the icon 2012/07/26*/
        }
        ...
        /*End: Modified by xiepengfei for modify editor activity 2012/04/25*/
