...
public class ImportExportDialogFragment extends DialogFragment
    ...
    /*Begin: Modified by siliangqi for multi_email 2012-6-20*/
    public static final int PHONE_SEND_BY_EMAIL = 8;
    /*End: Modified by siliangqi for multi_email 2012-6-20*/
    ...
    /*Begin: Modified by sunrise for ImportToSimFull 2012/08/01*/
    private static final int TOAST_EXPORT_SIM_FULL = 2;
    /*End: Modified by sunrise for ImportToSimFull 2012/08/01*/
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        if (res.getBoolean(R.bool.config_allow_share_visible_contacts)) {
            ...
            adapter.add(R.string.share_contacts_by_email);
        ...
        final DialogInterface.OnClickListener clickListener =
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                switch (resId) {
                    ...
                    case R.string.share_contacts_by_email: {
                    /*End: Modified by siliangqi for multi_email 2012-6-25*/
                        dismissDialog = true;
                        /*Begin: Modified by siliangqi for multi_email 2012-6-25*/
                        Intent intent = new Intent(ACTION_MULTI_PICK,Contacts.CONTENT_URI);
                        getActivity().startActivityForResult(intent, PHONE_SEND_BY_EMAIL);
    ...
    /*Begin: Modified by siliangqi for multi_email 2012-6-20*/
    public void doShare(Cursor c,Context context){
        doShareVisibleContacts(c,context);
    }
    private void doShareVisibleContacts(Cursor c,Context context) {
    ...
    public class ExportToSimThread extends Thread {
        ...
        private Uri insert(String name, String number, int subscription) {
            ...
            if (result != null){
                ...
                /*Begin: Modified by sunrise for ImportToSimFull 2012/08/01*/
                if (mSimContactsOperation.isSimContactsFull(subscription))
                {
                    mToastHandler.sendEmptyMessage(TOAST_EXPORT_SIM_FULL);
                }
                else
                {
            ...
            public void handleMessage(Message msg) {
                switch (msg.what) {
                    ...
                    case TOAST_EXPORT_FINISHED:
                        ...
                        break;
                    /*Begin: Modified by sunrise for ImportToSimFull 2012/08/01*/
                    case TOAST_EXPORT_SIM_FULL:
                        Toast.makeText(mpeople, R.string.contactSavedToSimCardError, Toast.LENGTH_SHORT).show();
                        break;
                        default:
                            Toast.makeText(mpeople, R.string.export_finished, Toast.LENGTH_SHORT).show();
                            break;
